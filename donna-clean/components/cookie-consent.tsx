...
export function CookieConsent() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 p-4 bg-secondary border-t border-purple-500/30 shadow-lg animate-in slide-in-from-bottom">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="px-6 py-2 text-sm bg-[#8b5cf6] hover:bg-[#7c3aed] text-white rounded-md font-medium transition-colors whitespace-nowrap"
            >
              Accept
            </button>
            <button
